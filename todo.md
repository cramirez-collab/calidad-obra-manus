...
## BUG: Error de importación dinámica en NuevoItem.tsx
- [x] Diagnosticar error "Failed to fetch dynamically imported module"
- [x] El error era temporal por cache de Vite - se resolvió con reinicio del servidor
- [x] Verificar que la página /items/nuevo funciona correctamente

## BUG CRÍTICO: No funciona en móvil
- [x] Diagnosticar por qué no muestra opción de iniciar sesión en móvil
- [x] Agregar página de login para usuarios no autenticados
- [x] Hacer la página de selección de proyecto responsive para móvil
