  ...
  return (
    <DashboardLayout>
      <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto">
        ...
        {/* Sección WhatsApp - Enlace al submenú (Solo Admin) */}
        {isAdmin && (
          <Card className="mt-6 border-green-500/20 bg-green-500/5">
            <CardHeader className="pb-3">
              <CardTitle className="flex items-center gap-2 text-base">
                <MessageCircle className="h-5 w-5 text-green-600" />
                Recordatorio - Reportes Automáticos
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground mb-4">
                Configura los recordatorios automáticos con días y horarios de envío para reportes de actividad de residentes.
              </p>
