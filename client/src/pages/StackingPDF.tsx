...
export default function StackingPDF() {
  ...
  // Agrupar unidades por nivel - ordenado de MAYOR a MENOR para el PDF
  const celdasPorNivel = useMemo(() => {
    ...
    // Ordenar niveles DESCENDENTE (mayor a menor) para el PDF
    ...
    <DashboardLayout>
      <div className="space-y-4">
        ...
        <div ref={printRef} className="print:p-4">
          ...
          {/* Cuadrícula del stacking - ordenado de mayor a menor */}
          <div className="border rounded-lg p-4 print:p-2 print:border-gray-300">
            <h2 className="font-semibold text-[#002C63] mb-3 print:text-sm print:mb-2">
              Cuadrícula de Unidades por Nivel (Mayor a Menor)
            </h2>
