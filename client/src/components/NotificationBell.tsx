  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span 
            className="absolute -top-3 -right-2 h-5 min-w-[20px] px-1.5 flex items-center justify-center text-[10px] font-bold text-white bg-red-500 rounded-full shadow-lg ring-2 ring-white z-10"
          >
